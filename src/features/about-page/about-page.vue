<template>
  <div class="about-container">
    ...
    <div class="paraOne">
      ...
      <p>
        {{
          `Founded in 2003 by Sensei Ewan Tempero (5th degree Black Belt) and Sensei Tom Davies (4th degree Black Belt), The University of Auckland Gōjū Ryū Karate Club has been running for over ${new Date().getFullYear() -
            2003} years.`
        }}
      </p>
      <p>
